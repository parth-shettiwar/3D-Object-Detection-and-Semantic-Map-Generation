...
class SunrgbdDatasetConfig(object):
    def __init__(self, flag=0):
        ...
        if flag==0:
            ...
            self.type2class={'book':0, 'bottle':1, 'bowl':2, 'cup':3, 'keyboard':4, 'mouse':5, 'plant':6, 'tv':7}
        ...
        if flag==0:
            ...
            self.type2onehotclass={'book':0, 'bottle':1, 'bowl':2, 'cup':3, 'keyboard':4, 'mouse':5, 'plant':6, 'tv':7}
        if flag==0:
            ...
            self.type_mean_size = {'book': np.array([0.257587, 0.268778, 0.09091]),
                            'bottle': np.array([0.131452, 0.129042, 0.254546]),
                            'bowl': np.array([0.255872, 0.246378, 0.136364]),
                            'cup': np.array([0.12365, 0.126294, 0.145454]),
                            'keyboard': np.array([0.194539, 0.475397, 0.073738]),
                            'mouse': np.array([0.136364, 0.121284, 0.081818]),
                            'plant': np.array([0.461254, 0.48922699999999997, 0.870455]),
                            'tv': np.array([0.252098, 0.86244, 0.645454])}
